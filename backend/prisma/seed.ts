...
const QUESTIONS = [
  ...
  { text: 'Quem traiu Jesus com um beijo?', type: 'multiple_choice', optionA: 'Pedro', optionB: 'João', optionC: 'Judas', optionD: 'Tomé', answer: 'Judas', explanation: 'Judas Iscariotes traiu Jesus com um beio, entregando-O aos soldados.', book: 'Mateus', chapter: 26, verse: 49, difficulty: 'easy', category: 'Paixão de Cristo', xp: 100 },
  ...
  { text: '"Não haverá nenhuma recompensa para o malvado" — Quem disse isso?', type: 'who_said', optionA: 'Davi', optionB: 'Salomão', optionC: 'Jó', optionD: 'Paulo', answer: 'Salomão', explanation: 'Salomão, em Provérbios, ensinou que o mal não terá recompensa.', book: 'Provérbios', chapter: 11, verse: 31, difficulty: 'medium', category: 'Provérbios', xp: 150 },
  ...
  { text: 'Jesus caminhou sobre as águas do Mar da Galileia.', type: 'true_false', answer: 'True', explanation: 'Jesus caminhou sobre as águas para alcanar os discípulos que estavam no barco.', book: 'Mateus', chapter: 14, verse: 25, difficulty: 'hard', category: 'Milagres', xp: 200 },
  ...
  { text: 'Em qual cidade Paulo escreveu a Carta aos Filipenses?', type: 'multiple_choice', optionA: 'Roma', optionB: 'Efeso', optionC: 'Prision', optionD: 'Atenas', answer: 'Prision', explanation: 'Paulo escreveu Filipenses estando preso, possivelmente em Roma.', book: 'Filipenses', chapter: 1, verse: 7, difficulty: 'hard', category: 'Epístolas', xp: 200 },
