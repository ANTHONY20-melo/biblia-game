...
const QUESTIONS = [
  ...
  // ─── PERSONAGENS (Modo "Quem é o Personagem?") ───
  { text: 'Fui o primeiro homem criado por Deus, formado do pó da terra.', type: 'character', optionA: 'Adão', optionB: 'Noé', optionC: 'Abraão', optionD: 'Seth', answer: 'Adão', explanation: 'Adão foi o primeiro homem, criado por Deus no sexto dia da criação.', book: 'Gênesis', chapter: 2, verse: 7, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Construí uma arca gigantesca para salvar minha família e os animais do dilúvio.', type: 'character', optionA: 'Moisés', optionB: 'Noé', optionC: 'Abraão', optionD: 'Jacó', answer: 'Noé', explanation: 'Noé obedeceu a Deus e construiu a arca, salvando sua família e pares de cada animal.', book: 'Gênesis', chapter: 6, verse: 14, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Fui pai de muitas nações, deixei minha terra por fé e quase sacrifiquei meu filho Isaque.', type: 'character', optionA: 'Isaque', optionB: 'Jacó', optionC: 'Abraão', optionD: 'José', answer: 'Abraão', explanation: 'Abraão é o pai da fé, chamado por Deus para deixar Ur e ir para Canaã.', book: 'Gênesis', chapter: 12, verse: 1, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Vendi meu próprio irmão como escravo, mas depois o perdoei e salvei minha família da fome no Egito.', type: 'character', optionA: 'Rúben', optionB: 'Judá', optionC: 'José', optionD: 'Benjamim', answer: 'José', explanation: 'José foi vendido pelos irmãos, tornou-se governador do Egito e perdoou seus irmãos.', book: 'Gênesis', chapter: 37, verse: 28, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Fui libertado da escravidão no Egito por Moisés, dividi o Mar Vermelho e recebi os Dez Mandamentos.', type: 'character', optionA: 'Josué', optionB: 'Moisés', optionC: 'Aarão', optionD: 'Calebe', answer: 'Moisés', explanation: 'Moisés liderou o Êxodo, dividiu o mar e recebeu a Lei no Monte Sinai.', book: 'Êxodo', chapter: 14, verse: 21, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Fui a mulher que escondeu espias em Jericó e salvei minha família com um fio escarlate na janela.', type: 'character', optionA: 'Débora', optionB: 'Rute', optionC: 'Raabe', optionD: 'Ester', answer: 'Raabe', explanation: 'Raabe protegeu os espias israelitas e foi salva quando Jericó caiu.', book: 'Josué', chapter: 2, verse: 1, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui juíza e profetisa em Israel, liderei o exército com Baraque e cantei vitória ao Senhor.', type: 'character', optionA: 'Rute', optionB: 'Débora', optionC: 'Ana', optionD: 'Miriã', answer: 'Débora', explanation: 'Débora foi juíza e profetisa, liderou Israel à vitória contra os cananeus.', book: 'Juízes', chapter: 4, verse: 4, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui forte como ninguém, mas minha força estava no cabelo; fui traído por Dalila.', type: 'character', optionA: 'Gideão', optionB: 'Sansão', optionC: 'Samuel', optionD: 'Davi', answer: 'Sansão', explanation: 'Sansão foi nazireu, sua força vinha do cabelo; Dalila o traiu cortando-o.', book: 'Juízes', chapter: 16, verse: 17, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui pastor de ovelhas, matei um gigante com uma pedra e me tornei o maior rei de Israel.', type: 'character', optionA: 'Saul', optionB: 'Davi', optionC: 'Salomão', optionD: 'Josué', answer: 'Davi', explanation: 'Davi, o pastor que venceu Golias, tornou-se rei e homem segundo o coração de Deus.', book: '1 Samuel', chapter: 17, verse: 50, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Pedi sabedoria a Deus em vez de riquezas, construí o Templo e julguei com sabedoria famosa.', type: 'character', optionA: 'Davi', optionB: 'Salomão', optionC: 'Ezequias', optionD: 'Josafá', answer: 'Salomão', explanation: 'Salomão pediu sabedoria, construiu o Templo e escreveu Provérbios e Eclesiastes.', book: '1 Reis', chapter: 3, verse: 9, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui profeta, desafiei 450 profetas de Baal no Monte Carmelo e vi fogo descer do céu.', type: 'character', optionA: 'Isaías', optionB: 'Eliseu', optionC: 'Elias', optionD: 'Jeremias', answer: 'Elias', explanation: 'Elias desafiou os profetas de Baal; Deus respondeu com fogo, provando que Ele é o verdadeiro Deus.', book: '1 Reis', chapter: 18, verse: 38, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui jogado numa cova de leões por orar a Deus, mas os leões não me tocaram.', type: 'character', optionA: 'Daniel', optionB: 'Ezequiel', optionC: 'Isaías', optionD: 'Jeremias', answer: 'Daniel', explanation: 'Daniel foi fiel a Deus na cova dos leões; Deus enviou anjo para fechar a boca dos leões.', book: 'Daniel', chapter: 6, verse: 22, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui a rainha que arriscou a vida para salvar meu povo de um decreto de morte na Pérsia.', type: 'character', optionA: 'Vasti', optionB: 'Ester', optionC: 'Raabe', optionD: 'Débora', answer: 'Ester', explanation: 'Ester, rainha da Pérsia, intercedeu pelo povo judeu e o salvou da destruição.', book: 'Ester', chapter: 4, verse: 16, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui um cobrador de impostos odiado, subi numa figueira para ver Jesus e Ele entrou na minha casa.', type: 'character', optionA: 'Mateus', optionB: 'Zaqueu', optionC: 'Pedro', optionD: 'André', answer: 'Zaqueu', explanation: 'Zaqueu, chefe dos publicanos, subiu na figueira; Jesus o convidou e a salvação entrou em sua casa.', book: 'Lucas', chapter: 19, verse: 5, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Neguei Jesus três vezes antes do galo cantar, mas depois me arrependi e fui restaurado.', type: 'character', optionA: 'João', optionB: 'Tiago', optionC: 'Pedro', optionD: 'André', answer: 'Pedro', explanation: 'Pedro negou Jesus três vezes, mas foi restaurado e tornou-se líder da igreja primitiva.', book: 'Mateus', chapter: 26, verse: 75, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Fui o "discípulo amado", escrevi o quarto Evangelho, três cartas e o Apocalipse.', type: 'character', optionA: 'Pedro', optionB: 'Paulo', optionC: 'João', optionD: 'Tiago', answer: 'João', explanation: 'João, o discípulo amado, escreveu o Evangelho de João, 1-3 João e Apocalipse.', book: 'João', chapter: 21, verse: 20, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Persegui a igreja, caí no caminho de Damasco, vi a luz e me tornei o apóstolo dos gentios.', type: 'character', optionA: 'Pedro', optionB: 'Barnabé', optionC: 'Paulo', optionD: 'Estevão', answer: 'Paulo', explanation: 'Saulo (Paulo) perseguiu cristãos, converteu-se no caminho de Damasco e tornou-se apóstolo dos gentios.', book: 'Atos', chapter: 9, verse: 3, difficulty: 'easy', category: 'Personagens', xp: 100 },
  { text: 'Fui a mãe de Samuel, o dediquei ao Senhor e cantei um cântico de vitória e louvor.', type: 'character', optionA: 'Sara', optionB: 'Ana', optionC: 'Rebeca', optionD: 'Raquel', answer: 'Ana', explanation: 'Ana, estéril, orou por um filho; dedicou Samuel ao Senhor e cantou um cântico profético.', book: '1 Samuel', chapter: 1, verse: 27, difficulty: 'medium', category: 'Personagens', xp: 150 },
  { text: 'Fui profeta chorão, preguei juízo sobre Judá e vi Jerusalém ser destruída pelos babilônios.', type: 'character', optionA: 'Isaías', optionB: 'Jeremias', optionC: 'Ezequiel', optionD: 'Daniel', answer: 'Jeremias', explanation: 'Jeremias, o profeta chorão, avisou do juízo e viu a queda de Jerusalém.', book: 'Jeremias', chapter: 1, verse: 5, difficulty: 'hard', category: 'Personagens', xp: 200 },
  { text: 'Vi a glória de Deus num carro de fogo com rodas cheias de olhos e criaturas vivas.', type: 'character', optionA: 'Isaías', optionB: 'Ezequiel', optionC: 'Daniel', optionD: 'Jeremias', answer: 'Ezequiel', explanation: 'Ezequiel teve visões da glória de Deus, dos querubins e do vale de ossos secos.', book: 'Ezequiel', chapter: 1, verse: 4, difficulty: 'hard', category: 'Personagens', xp: 200 },
  { text: 'Interpretei sonhos do faraó, preví 7 anos de fartura e 7 de fome, e salvei o Egito e minha família.', type: 'character', optionA: 'José', optionB: 'Daniel', optionC: 'Moisés', optionD: 'José do Egito', answer: 'José', explanation: 'José interpretou os sonhos do faraó, tornou-se governador e salvou muitos da fome.', book: 'Gênesis', chapter: 41, verse: 39, difficulty: 'medium', category: 'Personagens', xp: 150 },
